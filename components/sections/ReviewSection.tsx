            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    <div className="bg-slate-50 rounded-3xl p-6 border border-slate-100">
                        <SectionHeader title="Biodata Siswa" step={1} />
                    ...
                    <div className="bg-slate-50 rounded-3xl p-6 border border-slate-100">
                        <SectionHeader title="Orang Tua & Kontak" step={2} />
                ...
                <div className="space-y-6">
                    <div className="bg-emerald-50/50 rounded-3xl p-6 border border-emerald-100">
                        <SectionHeader title="Dokumen Terlampir" step={3} />
                                    ...
                                    {doc.file ? (
                                        <>
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <span>{doc.name}:</span> <span className="text-[10px] opacity-70 italic truncate ml-1">{doc.file.name}</span>
                                            </div>
                                        </>
                                    ) : (
                                        <>
